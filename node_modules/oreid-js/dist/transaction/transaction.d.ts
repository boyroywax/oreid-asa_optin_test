...
import { CreateTransactionData, ExternalWalletType, SignWithOreIdResult, TransactionData } from '../models';
...
export default class Transaction {
    ...
    signWithWallet(walletType: ExternalWalletType): Promise<{
        signedTransaction: import("../models").SignatureProviderSignResult;
    }>;
}
