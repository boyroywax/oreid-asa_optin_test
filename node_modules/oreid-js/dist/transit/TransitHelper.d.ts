...
export default class TransitHelper {
    ...
    private getChainNetworkNextworkConfig;
    ...
    signWithTransitProvider(transactionData: TransactionData, transitProvider: ExternalWalletType): Promise<{
        signedTransaction: SignatureProviderSignResult;
    }>;
    signStringWithTransitProvider({ walletType, chainNetwork, string, message }: SignStringParams): Promise<{
        signedString: string;
    }>;
